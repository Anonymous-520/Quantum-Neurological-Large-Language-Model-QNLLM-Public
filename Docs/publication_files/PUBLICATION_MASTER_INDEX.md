# QNLLM v2.9: Master Publication Index
...
|----------|---------|----------|
| **[QNLLM_v2.9_WHITEPAPER.md](QNLLM_v2.9_WHITEPAPER.md)** | Academic paper (9 sections + appendices) | Researchers, reviewers |
...
- **Frozen Snapshot:** `data/snapshot_v2.9.qnllm`

### Documentation
- **Whitepaper:** `docs/QNLLM_v2.9_WHITEPAPER.md`
